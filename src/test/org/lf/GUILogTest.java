...
public class GUILogTest extends JPanel implements ActionListener, PropertyChangeListener {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        task = new Task(evt.getActionCommand());
    ...
    public static void main(String[] args) {
    	try{
			Log fileLog = new FileBackedLog("test-data/test3", new LineParser());
