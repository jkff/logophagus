...
class ForwardTransitionFunction{
	...
	public ForwardTransitionFunction(char recordDelimeter, char fieldDelimeter,
			char quoteCharacter, char escapeCharacter)
	{
		...
		map.put(new StateAndSymbolType(State.QUOTE_BEGIN, SymbolType.FIELD_DELIMETER), State.IN_QUOTE);
		...
		map.put(new StateAndSymbolType(State.BETWEEN_FIELDS, SymbolType.RECORD_DELIMETER), State.RECORD_BORDER);
		map.put(new StateAndSymbolType(State.BETWEEN_FIELDS, SymbolType.ESCAPE), State.FIELD);
		map.put(new StateAndSymbolType(State.BETWEEN_FIELDS, SymbolType.FIELD_DELIMETER), State.BETWEEN_FIELDS);
		...
		map.put(new StateAndSymbolType(State.RECORD_BORDER, SymbolType.FIELD_DELIMETER), State.BETWEEN_FIELDS);
